...
def periodfunc():
	...
	os.system('raspistill -o /home/pi/Desktop/1119/'+time.strftime("%Y%m%d-%H%M%S")+'.jpg')
    	#os.system('scp -i /home/pi/Desktop/crowdkey.pem /home/pi/Desktop/imag.jpg ec2-user@ec2-3-86-252-46.compute-1.amazonaws.com:/home/ec2-user/crowddetector/backend/images') 
##   	count+=1
